...
`Figure1_TruePositiveRate.png` (Figure 1), 

`Figure5_TPR_vs_FPR_scatter.png` (Figure 2), 

`Figure7_PerVariable_Bias_N500_rho0.png` (Figure 3), 

`Figure8_Correlation_Effect_on_TPR.png` (Figure 4).
