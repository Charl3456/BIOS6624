...
t2 <- results_tbl |>
  ...
  arrange(Method)
knitr::kable(t2,
  caption = "Mean true positive rate (TPR) and false positive rate (FPR) by method, averaged across all six simulation conditions ($N \\in \\{250, 500\\}$, $\\rho \\in \\{0, 0.35, 0.70\\}$). Standard deviations across conditions are shown in parentheses.",
